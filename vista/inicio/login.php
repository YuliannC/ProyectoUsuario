...
<div class="container" id="container">
            ...
            <form role="form" class="text-start"  class="frmLogin" id="frmLogin"  name="frmLogin"
                  ...
                  <div class="text-center">
                    <input type="submit" value="Ingresar"  name="post" class="btn bg-gradient-primary w-100 my-4 mb-2">
                  </div>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    ...
                    <div class="overlay-panel overlay-right">
                        <h1>Bienvenida</h1>
                        <p>Aqui encontraras tus comodidad, belleza, calidad, y economia.</p>
                        <a type="submit" style="color:white;" href="?controlador=inicio&accion=frmRegistrocliente">Registrarse</a>
                    </div>
                </div>
            </div>
            </div>
